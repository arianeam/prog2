...
void ligar_nos (no_t *fonte, no_t *destino)
{
    if (fonte == NULL || destino == NULL){
        fprintf(stderr,"liga_nos: ponteiros invalidos 1");
        exit(EXIT_FAILURE);
    }
...
{
    if (no == NULL) {
        fprintf(stderr,"liga_nos: ponteiros invalidos 2");
        exit(EXIT_FAILURE);
    }
...
{
    if (no == NULL) {
        fprintf(stderr,"liga_nos: ponteiros invalidos 3");
        exit(EXIT_FAILURE);
    }
...
{
    if (no == NULL) {
        fprintf(stderr,"liga_nos: ponteiros invalidos 4");
        exit(EXIT_FAILURE);
    }
...
{
    if (no == NULL) {
        fprintf(stderr,"liga_nos: ponteiros invalidos 5");
        exit(EXIT_FAILURE);
    }
